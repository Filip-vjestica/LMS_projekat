...
public class AdminRegistrovaniKorisnikDTO {
	private Long id;
	...
	public AdminRegistrovaniKorisnikDTO() {
		super();
	}

	public AdminRegistrovaniKorisnikDTO(RegistrovaniKorisnik registrovaniKorisnik) {
		super();
	...
	public AdminRegistrovaniKorisnikDTO(Long id, String username, String ime, String prezime, String jmbg,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AdminRegistrovaniKorisnikDTO other = (AdminRegistrovaniKorisnikDTO) obj;
		if (id == null) {
			if (other.id != null)
				return false;
